...
namespace MultiShop.WebUI.Services.DiscountServices
{
    public class DiscountService : IDiscountService
    {
        ...
        {
            var responseMessage = await _httpClient.GetAsync("http://localhost:7131/api/Discounts/GetCodeDetailByCodeAsync?code=" + code);
        ...
        {
            var responseMessage = await _httpClient.GetAsync("http://localhost:7131/api/Discounts/GetDiscountCouponCountRate?code=" + code);
